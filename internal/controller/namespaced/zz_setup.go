// SPDX-FileCopyrightText: 2024 The Crossplane Authors <https://crossplane.io>package namespaced
...
// Setup creates all namespaced-scoped controllers and adds them to the supplied manager.
