...
// ResolveReferences of this IntegrationLog.
func (mg *IntegrationLog) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
...
// ResolveReferences of this IntegrationMetric.
func (mg *IntegrationMetric) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
...
// ResolveReferences of this IntegrationPrometheus.
func (mg *IntegrationPrometheus) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
